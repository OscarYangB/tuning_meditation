...
constexpr float STOPPING_THRESHOLD = 0.55f;

constexpr float MIN_VIBRATO_FREQUENCY = 4.f;
constexpr float MAX_VIBRATO_FREQUENCY = 7.f;
constexpr float MAX_VIBRATO_AMPLITUDE = 0.015f;
